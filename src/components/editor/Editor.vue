<template>
  <div class="editor-view">
    ...
    <EditorJSHost ref="editor" @ready="ready = true" @selectTool="currentTool = $event" :scroll-lock="scrollLock"></EditorJSHost>
  </div>
</template>
...
import ToolRibbon from "@/components/editor/ToolRibbon.vue";
